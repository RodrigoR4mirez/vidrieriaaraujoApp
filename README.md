...
`verify` ejecuta lint, tipos, unitarias/integración y build. Los casos oficiales dan **S/ 62.25** y **S/ 208.10**. Playwright usa el servidor real y Blob de Preview/desarrollo, no una base simulada:
